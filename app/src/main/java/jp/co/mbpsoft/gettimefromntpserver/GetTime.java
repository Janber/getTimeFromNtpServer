...
/**
 * ===========================================================
 * Copyright (C) MBP Japan Inc. All Rights Reserved
 * Created by WU JIANBO
 * Created at 2018/03/19 9:45
 * 機能説明：
 * ============================================================
 */
...
public class GetTime {
    public static void main(String[] args) {
        ...
        if (client.requestTime("0.jp.pool.ntp.org", 30000)) {
            ...
            System.out.println("ntp時間:"+current.toString());
        }else {
            System.out.println("ntp時間取得失敗！");
        }
    ...
    private final String LOG_TAG = "ntpHost";
